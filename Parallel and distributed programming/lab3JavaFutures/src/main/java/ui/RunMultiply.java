 ...
 */
public class RunMultiply implements Runnable {
    ...
    public RunMultiply(int maxNumberOfThreads, Matrix matrixA, Matrix matrixB, Matrix matrixResult, Controller controller, long time, long mostEfficientTime, int mostEfficientNumberOfThreads)
    {
    ...
    public void run()
    {
        ...
        for (int i = 1; i < maxNumberOfThreads; i++)
        {
            ...
            controller.multiply(matrixA, matrixB, matrixResult, i);
        ...
        System.out.println("Fastest time: " + mostEfficientTime + "milis");
